...
network analysis, describing its generation principle, relevant
properties and why we tend to use it. Note that this table is very
terse, as many of these networks are well studied and have many
properties and there are also many many more model networks out
there. So, you should consider this list as a starting point.
